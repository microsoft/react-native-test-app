...
class MainReactNativeHost(
    ...
    fun init(beforeReactNativeInit: () -> Unit, afterReactNativeInit: () -> Unit) {
        ...
        // When we reference `reactInstanceManager` below, `ReactNativeHost`
        // will start creating a `ReactInstanceManager` instance.
        ...
        if (BuildConfig.REACTAPP_USE_BRIDGELESS) {
            ...
            reactHost.addReactInstanceEventListener(object : ReactInstanceEventListener {
                override fun onReactContextInitialized(context: ReactContext) {
                    ...
                    reactHost.devSupportManager?.let { addCustomDevOptions(it) }
                    ...
                    synchronized(reactInstanceEventListeners) {
                        ...
                        while (i.hasNext()) {
                            i.next().onReactContextInitialized(context)
                        }
                    }
                }
            })
