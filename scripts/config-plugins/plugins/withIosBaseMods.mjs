...
import { resolvePackageLocation } from "../../helpers.js";
...
defaultProviders["reactNativeHost"] = makeFilePathModifier(
  resolvePackageLocation("@rnx-kit/react-native-host"),
  true
)(expoProviders.appDelegate, "cocoa/ReactNativeHost.mm");
